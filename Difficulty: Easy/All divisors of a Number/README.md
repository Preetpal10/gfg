<h2><a href="https://www.geeksforgeeks.org/problems/all-divisors-of-a-number/1?page=2&category=Java&status=unsolved&sortBy=submissions">All divisors of a Number</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer <strong>n,</strong> return all the divisors of n in the <strong>ascending </strong>order.</span><br>&nbsp;<br><span style="font-size: 18px;"><strong>Examples:</strong></span></p>
