<h2><a href="https://www.geeksforgeeks.org/problems/count-only-once/1?page=6&category=Java&status=unsolved&sortBy=submissions">Count Only Once</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">You are given an integer array <strong>arr[]</strong> of integers. You need to find how many elements exist if we count the elements only once. That is repeated elements are counted as occuring once.</span></p>
