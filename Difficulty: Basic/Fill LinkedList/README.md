<h2><a href="https://www.geeksforgeeks.org/problems/fill-linkedlist/1?page=10&category=Java&sortBy=submissions">Fill LinkedList</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">You are given an integer LinkedList <strong>ll</strong>, you are also given a value <strong>k</strong>. You need to fill arr with k.</span></p>
