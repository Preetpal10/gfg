<h2><a href="https://www.geeksforgeeks.org/problems/equals-method/1?page=9&category=Java&sortBy=submissions">Equals Method</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a two integer arrays <strong>a[] </strong>and <strong>b[]</strong>, you need to find if both the arrays contain the same elements in the same order or not. </span></p>
